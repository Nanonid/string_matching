...
class DecoderCharacterClassGenerator extends DecoderGenerator {
...
''';
  ...
  DecoderCharacterClassGenerator(InterpreterClassGenerator interpreterClassGenerator) : super(interpreterClassGenerator) {
