...
class DecoderAnyCharacterGenerator extends DecoderGenerator {
...
''';
  ...
  DecoderAnyCharacterGenerator(InterpreterClassGenerator interpreterClassGenerator) : super(interpreterClassGenerator) {
