...
class InstructionTypes {
  ...
  static const InstructionTypes PRODUCTION_RULE = const InstructionTypes("PRODUCTION_RULE", 10);

  static const InstructionTypes RULE = const InstructionTypes("RULE", 11);

  static const InstructionTypes SEQUENCE = const InstructionTypes("SEQUENCE", 12);

  static const InstructionTypes SEQUENCE_ELEMENT = const InstructionTypes("SEQUENCE_ELEMENT", 13);

  static const InstructionTypes ZERO_OR_MORE = const InstructionTypes("ZERO_OR_MORE", 14);
